...
do -- Combat page
    ...
    do -- Ragebot
      ...
      s1:Slider({Name="Max Cache", Flag="CAT_Max_Cache_30",    Min=0.1, Max=25,  Default=0.5,   Decimals=0.01, Callback=function(v) WB.Threshold=v end})
        ...
        s2:Dropdown({Name="Hit Sound", Flag="CAT_Hit_Sound_36",   Items={"None","Skeet","Neverlose","Gamesense","A"}, Default="None", Callback=function(v) HitSoundSelection=v end})
    end
end
